...
/**
 * Servlet Filter implementation class sesconuserFilter
 */
@WebFilter({ "/sesconuserFilter", "*.doo" })
public class sesconuserFilter implements Filter {

    /**
     * Default constructor. 
     */
    public sesconuserFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		String s=(String) session.getAttribute("validuser");
		 if(s!=null && s.contentEquals("yes")) {

			 System.out.println("second if camee");
			 chain.doFilter(request, response);
